...
public class InstanceServiceImpl implements IInstanceService {
    ...
    public java.util.List<com.oracle.bmc.identity.model.ApiKey> listApiKeys(String ociCfgId) {
        ...
        try (OracleInstanceFetcher fetcher = new OracleInstanceFetcher(sysUserDTO)) {
            ...
            log.error("【SSH密钥】获取列表失败, 账户:[{}]", sysUserDTO.getUsername(), e);
            throw new OciException(-1, "获取密钥列表失败: " + e.getMessage());
        }
    }
    ...
    public void deleteApiKey(String ociCfgId, String fingerprint) {
        ...
        try (OracleInstanceFetcher fetcher = new OracleInstanceFetcher(sysUserDTO)) {
            ...
            log.info("【SSH密钥】删除成功, 账户:[{}], 指纹:[{}]", sysUserDTO.getUsername(), fingerprint);
        } catch (Exception e) {
            log.error("【SSH密钥】删除失败, 账户:[{}], 指纹:[{}]", sysUserDTO.getUsername(), fingerprint, e);
            throw new OciException(-1, "删除密钥失败: " + e.getMessage());
        }
    }
    ...
    public void addApiKey(String ociCfgId, String publicKeyContent) {
        ...
        try (OracleInstanceFetcher fetcher = new OracleInstanceFetcher(sysUserDTO)) {
            ...
            log.info("【SSH密钥】上传成功, 账户:[{}]", sysUserDTO.getUsername());
        } catch (Exception e) {
            log.error("【SSH密钥】上传失败, 账户:[{}]", sysUserDTO.getUsername(), e);
            throw new OciException(-1, "上传公钥失败: " + e.getMessage());
        }
    }
}
...
//                                log.info("放货推送成功,body:{}", body);
    ...
    public void createSnapshot(com.tony.kingdetective.bean.params.oci.instance.CreateSnapshotParams params) {
        SysUserDTO sysUserDTO = sysService.getOciUser(params.getOciCfgId());
        try (OracleInstanceFetcher fetcher = new OracleInstanceFetcher(sysUserDTO)) {
            BootVolume bootVolume = fetcher.getBootVolumeByInstanceId(params.getInstanceId());
            String snapshotName = cn.hutool.core.util.StrUtil.isBlank(params.getSnapshotName()) ? 
                    ("manual-snapshot-" + System.currentTimeMillis()) : params.getSnapshotName();
            ...
            log.info("【创建快照】创建快照成功, 实例ID:[{}], 快照名:[{}]", params.getInstanceId(), snapshotName);
        } catch (Exception e) {
            log.error("【创建快照】创建快照失败, 实例ID:[{}]", params.getInstanceId(), e);
            throw new OciException(-1, "创建快照失败: " + e.getMessage());
    ...
    public void updateTags(com.tony.kingdetective.bean.params.oci.instance.UpdateTagsParams params) {
        ...
        try (OracleInstanceFetcher fetcher = new OracleInstanceFetcher(sysUserDTO)) {
            ...
            if (cn.hutool.core.util.StrUtil.isNotBlank(params.getTagsJson())) {
                try {
                    Map<Object, Object> parsedMap = cn.hutool.json.JSONUtil.toBean(params.getTagsJson(), Map.class);
                    parsedMap.forEach((k, v) -> tags.put(String.valueOf(k), String.valueOf(v)));
                } catch (Exception e) {
                    throw new OciException(-1, "JSON解析失败: 标签格式必须是合法JSON字符串");
    ...
    public void addApiKey(String ociCfgId, String publicKeyContent) {
        ...
        try (OracleInstanceFetcher fetcher = new OracleInstanceFetcher(sysUserDTO)) {
            ...
            log.info("【更新标签】更新标签成功, 实例ID:[{}]", params.getInstanceId());
        } catch (Exception e) {
            log.error("【更新标签】更新标签失败, 实例ID:[{}]", params.getInstanceId(), e);
            throw new OciException(-1, "更新实例标签失败: " + e.getMessage());
    ...
    public String getScheduledPower(String instanceId) {
        ...
        com.tony.kingdetective.bean.entity.OciKv cfg = kvService.getOne(
            new com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<com.tony.kingdetective.bean.entity.OciKv>()
                .eq(com.tony.kingdetective.bean.entity.OciKv::getCode, key)
        );
    ...
    public void setScheduledPower(String instanceId, String ociCfgId, String stopTime, String startTime) {
        ...
        com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<com.tony.kingdetective.bean.entity.OciKv> wrapper = 
            new com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<com.tony.kingdetective.bean.entity.OciKv>().eq(com.tony.kingdetective.bean.entity.OciKv::getCode, key);
        
        if (cn.hutool.core.util.StrUtil.isBlank(stopTime) || cn.hutool.core.util.StrUtil.isBlank(startTime)) {
            kvService.remove(wrapper);
            log.info("【定时配置】清除实例:[{}]的定时开关机任务", instanceId);
            return;
    ...
    public void addApiKey(String ociCfgId, String publicKeyContent) {
        ...
        com.tony.kingdetective.bean.entity.OciKv cfg = kvService.getOne(wrapper);
        
        if (cfg != null) {
            cfg.setValue(configStr);
            kvService.updateById(cfg);
        } else {
            cfg = new com.tony.kingdetective.bean.entity.OciKv();
    ...
    public void addApiKey(String ociCfgId, String publicKeyContent) {
        ...
        log.info("【定时配置】更新实例:[{}]的定时任务, 设置为: {}", instanceId, configStr);
